...
.chip-info    { background: rgba(33,150,243,0.12); color: #aeb7ff; }
.chip-zalo    { background: rgba(255,167,38,0.18); color: var(--mc-warning); }
.chip-success { background: rgba(0,200,83,0.12);   color: var(--mc-success); }
