...
.chip-info    { background: rgba(33,150,243,0.13); color: #aeb7ff; }
.chip-purple  { background: rgba(156,39,176,0.13); color: #6a1b9a; }
.chip-warning { background: rgba(255,145,0,0.18);  color: var(--mc-warning); }
.chip-error   { background: rgba(255,82,82,0.13);  color: var(--mc-danger); }
.chip-success { background: rgba(0,200,83,0.13);   color: var(--mc-success); }
