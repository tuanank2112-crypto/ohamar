...
.mtp {
  ...
  --at-body: #475066; --at-hint: #8b93a7; --at-hairline: var(--mc-line);
...
.mtp-sortbtn {
  flex-shrink: 0; border: 1px solid var(--at-hairline); background: var(--mc-surface); border-radius: 8px;
...
.mtp-filtbtn {
  flex-shrink: 0; width: 30px; height: 29px; border: 1px solid var(--at-hairline); background: var(--mc-surface);
...
.mtp-seg button {
  border: none; background: var(--mc-surface); font-family: inherit; font-size: 11px; padding: 4px 11px;
...
.mtp-chip {
  flex-shrink: 0; border: 1px solid var(--at-hairline); background: var(--mc-surface); border-radius: 9999px;
...
.mtp-sel { border: 1px solid var(--at-hairline); border-radius: 6px; padding: 4px 8px; font-size: 11.5px; color: var(--at-ink); background: var(--mc-surface); outline: none; font-family: inherit; }
...
.mtp-pg { border: 1px solid var(--at-line, var(--mc-line)); background: var(--mc-surface); border-radius: 6px; padding: 4px 10px; font-size: 12px; cursor: pointer; color: var(--at-ink, #141a24); }
...
.mtp-cell {
  ...
  border: 1.5px solid transparent; background: var(--mc-surface-alt); padding: 0;
}
