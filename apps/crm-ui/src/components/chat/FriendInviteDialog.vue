    ...
    <v-card class="invite-card">
      ...
      <v-card-text class="invite-body">
        ...
        <div class="hints">
          ...
          <button class="hint-chip" type="button" @click="message = 'Chào bạn, mình là nhân viên chăm sóc khách hàng. Kết bạn để mình hỗ trợ thông tin bạn đã đăng ký nhé!'">Giới thiệu</button>
