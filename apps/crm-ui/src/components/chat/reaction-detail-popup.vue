...
.close-btn:hover { background: var(--mc-surface-alt); color: var(--mc-ink); }
...
.tab-item:hover { background: var(--mc-surface-alt); }
.tab-item.active {
  background: var(--mc-surface);
  color: var(--mc-ink);
  font-weight: 600;
...
.tab-item.active .tab-count { color: var(--mc-ink); }
...
.user-row:hover { background: var(--mc-surface-alt); }
.user-avatar {
  width: 36px;
  height: 36px;
  border-radius: 50%;
