...
<template>
  <aside class="filter-rail" :class="{ collapsed }">
    ...
    <div class="fr-filters">
      ...
      >
        <span class="icon"><CoolIcon name="Users_Group" :size="14" /></span>
      ...
      >
        <span class="icon"><CoolIcon name="User_01" :size="14" /></span>
      ...
      >
        <span class="icon"><CoolIcon name="File_Upload" :size="14" /></span>
      ...
      <div class="filter-row filter-row-select" :title="collapsed ? 'Trạng thái KH' : ''">
        <span class="icon"><CoolIcon name="Tag" :size="14" /></span>
      ...
      <div class="filter-row filter-row-select" :title="collapsed ? 'Trạng thái Zalo' : ''">
        <span class="icon"><CoolIcon name="Chat" :size="14" /></span>
        <template v-if="!collapsed">
      ...
      <div class="filter-row filter-row-range" :title="collapsed ? 'Lead score range' : ''">
        <span class="icon"><CoolIcon name="Star" :size="14" /></span>
        <template v-if="!collapsed">
      ...
      <div class="filter-row filter-row-range" :title="collapsed ? 'Tin nhắn cuối: khoảng thời gian' : ''">
        <span class="icon"><CoolIcon name="Calendar" :size="14" /></span>
        <template v-if="!collapsed">
...
.filter-row.active .count { background: var(--mc-surface); color: var(--smax-primary); }
.filter-divider {
