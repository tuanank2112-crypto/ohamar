  ...
  <div class="note-row" :class="{ 'is-reply': isReply }">
    ...
    <div class="note-body-wrap">
      ...
      <div v-if="!editing" class="note-actions">
        ...
        <button v-if="!isReply" class="action-btn text" @click="$emit('reply', note.id)"> <CoolIcon name="Chat" :size="14" /> Trả lời </button>
        <button
        ...
        > <CoolIcon name="Settings_Future" :size="14" /> AI lịch hẹn </button>
...
.action-btn.danger:hover { color: var(--mc-danger); background: rgba(255,82,82,0.08); }
