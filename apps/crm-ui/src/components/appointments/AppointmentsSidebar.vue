  ...
  <aside class="apt-sidebar">
    ...
    <div class="side-section">
      <div class="sidebar-callout">
        <strong><CoolIcon name="Bulb" :size="14" /> Mẹo nhanh</strong><br>
...
.scope-toggle button:hover:not(.active) { background: rgba(255,255,255,.045); color: var(--at-ink); }
...
.mini-cal-head button:focus-visible,
.mini-cal-grid .day:focus-visible {
...
.sale-list .sale:hover { background: var(--at-surface-soft); color: var(--at-ink); }
.sale-list .sale:active { background: var(--at-surface-strong); }
...
.mini-cal-head button:hover { background: var(--at-surface-soft); color: var(--at-ink); }
.mini-cal-head button:active { background: var(--at-surface-strong); }
.mini-cal-grid {
  display: grid;
...
.mini-cal-grid .day:hover:not(.today):not(.selected) { background: var(--at-surface-soft); color: var(--at-ink); }
.mini-cal-grid .day:active { background: var(--at-surface-strong); }
.mini-cal-grid .day.muted { color: var(--at-muted); opacity: 0.4; }
.mini-cal-grid .day.today {
  background: var(--at-action);
  color: #fff;
  font-weight: 500;
  box-shadow: 0 4px 12px rgba(108,125,232,.24);
}
...
.filter-chip .pill.status-overdue   { background: rgba(251,191,36,.14); color: var(--mc-warning); }   /* mustard tint */
.filter-chip .pill.status-completed { background: rgba(52,211,153,.14); color: var(--mc-success); }   /* forest tint */
.filter-chip .pill.status-cancelled { background: var(--at-surface-strong); color: var(--at-muted); }
.filter-chip .pill.status-no_show   { background: rgba(248,113,113,.14); color: var(--mc-danger); }   /* coral tint */
