...
/**
 * Merge an authoritative list response into the current reactive list.
 * The list response wins for list fields, while detail-only contact fields and a newer
 * optimistic/socket preview survive an API response that was already in flight.
 */
