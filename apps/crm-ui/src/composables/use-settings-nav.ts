...
export const SETTINGS_GROUPS: SettingsGroup[] = [
  ...
  // Gộp "Thông báo hệ thống" (từ Tổ chức cũ) + "Trợ lý AI" (từ CRM cũ) + Dev/API.
  {
    ...
    items: [
      ...
      { id: 'crm-rag', label: 'Sản phẩm, tri thức & đơn hàng', icon: 'mdi-brain', route: '/crm-rag', permission: 'admin', resource: 'settings', aliases: ['rag', 'catalog', 'knowledge', 'đơn hàng', 'kho tri thức'] },
