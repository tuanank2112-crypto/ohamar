...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    path: '/crm-rag',
    name: 'CrmRag',
    component: () => import('@/views/CrmRagView.vue'),
  ...
  },
  {
    path: '/ohamar-bots',
    name: 'OhamarBots',
    component: () => import('@/views/OhamarBotsView.vue'),
    meta: { requiresAuth: true, title: 'Ohamar Bots' },
  },
  ...
  {
    // Tab "Hồ sơ KH tổng hợp" — thông tin Contact + aggregate Friend rows.
...
// brand. Title dạng "Tên màn hình · CRM".
const BRAND = 'CRM';
