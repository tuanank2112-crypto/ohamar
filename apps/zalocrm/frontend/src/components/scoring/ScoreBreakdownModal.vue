...
<template>
  <div v-if="open" class="modal-overlay" @click.self="$emit('close')">
    <div class="modal-card">
      ...
      <div v-if="loading" class="modal-loading"><CoolIcon name="Timer" :size="14" /> Đang tải…</div>

      <div v-else-if="data" class="modal-body">
        <!-- 4 sub-scores -->
        <section class="dim-section">
          <h4><CoolIcon name="Chart_Bar_Vertical_01" :size="14" /> 4 chiều chấm điểm</h4>
          <div class="dim-rows">
            <div class="dim-row">
              <div class="dim-label">
            ...
            <div class="dim-row">
              <div class="dim-label">
                <span><CoolIcon name="Compass" :size="14" /> Ý định mua</span>
            ...
            <div class="dim-row">
              <div class="dim-label">
                <span><CoolIcon name="Compass" :size="14" /> Phù hợp</span>
        ...
        <section v-if="data.autoTags && data.autoTags.length > 0" class="tags-section">
          <h4><CoolIcon name="Tag" :size="14" /> Thẻ tự động</h4>
          <div class="tags-list">
        ...
        <section v-if="data.contact" class="contact-section">
          <h4><CoolIcon name="User_01" :size="14" /> KH lớn (tổng hợp các nick)</h4>
      ...
      <div v-else class="modal-error"><CoolIcon name="Warning" :size="14" /> Không tải được dữ liệu</div>

      <footer class="modal-footer">
        <button class="btn-secondary" @click="$emit('close')">Đóng</button>
        <button v-if="data" class="btn-primary" @click="$emit('open-chat', data.id)"> <CoolIcon name="Chat" :size="14" /> Mở chat </button>
      </footer>
    </div>
  </div>
</template>
