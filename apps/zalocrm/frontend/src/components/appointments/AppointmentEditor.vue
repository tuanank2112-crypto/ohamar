...
.title-input-wrap:focus-within { border-color: var(--at-action); }
...
.sale-select:focus { border-color: var(--at-action); }
...
.cust-suggest-search:focus { border-color: var(--at-action); }
...
.dp-day.today { background: var(--at-action); color: #fff; font-weight: 500; }
/* Selected nhưng KHÔNG phải today: bg coral đậm để dễ thấy */
.dp-day.selected:not(.today) {
  background: var(--at-action-soft); color: var(--at-action-text, var(--at-action));
  box-shadow: inset 0 0 0 1px rgba(108,125,232,.32); font-weight: 500;
}
.dp-tip-divider {
...
.picker-display.open { border-color: var(--at-action); }
...
.tip-chip.active {
  background: var(--at-action-soft); color: var(--at-action-text, var(--at-action)); border-color: var(--at-action);
}
.tip-chip.smart {
...
.type-chip.active {
  border-color: var(--at-action); background: var(--at-action-soft); color: var(--at-action-text, var(--at-action));
}
.type-chip .type-ico {
...
.type-chip[data-t="call"]      .type-ico { background: rgba(251,191,36,.14); color: var(--mc-warning); }
.type-chip[data-t="message"]   .type-ico { background: rgba(52,211,153,.14); color: #1f4d39; }
.type-chip[data-t="meeting"]   .type-ico { background: rgba(248,113,113,.14); color: var(--mc-danger); }
.type-chip[data-t="follow_up"] .type-ico { background: rgba(251,191,36,.14); color: var(--mc-warning); }
...
.location-input-wrap:focus-within { border-color: var(--at-action); }
...
.notes-area:focus { border-color: var(--at-action); }
...
.at-btn--primary { background: var(--at-action); color: #fff; }
...
.editor { border-top: 3px solid var(--at-action, #6c7de8); }
.editor-head { background: linear-gradient(180deg, var(--brand-softer, #f2f8fc), var(--at-canvas, #fff)); }
.editor-head h2 { color: var(--at-ink); font-weight: 700; display: flex; align-items: center; gap: 7px; }
.editor-head h2 .head-ic { color: var(--at-action-text, var(--at-action)); }
...
.link-kh-btn { color: var(--at-action-text, var(--at-action)); }
...
.notes-area:focus,
.picker-display.open { border-color: var(--at-action); box-shadow: 0 0 0 3px var(--at-focus-ring, var(--at-action-soft)); }

/* Chips đang chọn → brand */
.type-chip.active,
.tag-chip.active,
.tip-chip.active,
.loc-chip.active { background: var(--at-action-soft); border-color: var(--at-action); color: var(--at-action-text, var(--at-action)); }

/* Ngày/giờ đang chọn → brand */
.dp-day.today { background: var(--at-action); color: #fff; }
.dp-day.selected:not(.today) { background: var(--at-action-soft); color: var(--at-action-text, var(--at-action)); border-color: var(--at-action); }
.tp-wheel-item.selected { color: var(--at-action-text, var(--at-action)); }

/* Nút primary (Tạo/Cập nhật + Xác nhận popup) → brand */
.at-btn--primary { background: var(--at-action); color: #fff; }
.at-btn--primary:hover:not(:disabled) { background: var(--at-primary-active); }
.at-btn--primary:active:not(:disabled) { background: var(--at-primary-active); transform: translateY(1px); }
</style>
