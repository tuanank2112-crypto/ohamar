  ...
  >
    <div class="pv-popup">
      ...
      <div class="pv-lock-emblem">
        <div class="pv-lock-hex"><div class="pv-lock-icon"><CoolIcon name="Lock" :size="14" /></div></div>
      </div>
...
.pv-nick-name {
  font-size: 13px; font-weight: 600; color: var(--mc-ink); margin-top: 2px;
}
.pv-nick-uid {
...
.pv-title {
  ...
  color: var(--mc-ink); margin-bottom: 4px;
  position: relative; z-index: 2;
}
.pv-subtitle {
  text-align: center; font-size: 11px; color: var(--mc-text);
...
.pv-encryption-proof {
  background: rgba(108,125,232,.14); border: 1px solid #dbeafe;
