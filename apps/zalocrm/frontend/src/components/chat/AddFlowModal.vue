        ...
        <div class="afm-body">
          ...
          <template v-else>
            ...
            <div class="afm-field">
              ...
              >
                ...
                <span class="afm-opt-ic">
                  <CoolIcon name="Chat_Conversation" :size="16" />
                </span>
                <span class="afm-opt-info">
                  ...
                  <span class="afm-opt-metarow">
                    ...
                    <span class="afm-opt-tag"><CoolIcon name="Clock" :size="11" /> {{ seq.estLabel }}</span>
            ...
            <div v-if="error" class="afm-error">
              <CoolIcon name="Circle_Warning" :size="15" />
              <span>{{ error }}</span>
            </div>
          </template>
        </div>
...
.afm-opt-ic {
  ...
  background: var(--success-soft); color: var(--mc-success);
}
...
.afm-opt-start { font-size: 10.5px; color: var(--mc-success); margin-top: 5px; }
.afm-preview-btn {
