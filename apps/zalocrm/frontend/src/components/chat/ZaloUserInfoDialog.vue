...
.zui-handle {
  font-size: 11px; color: var(--mc-text); font-family: monospace;
  margin-top: 4px;
  display: flex; justify-content: center; gap: 8px; flex-wrap: wrap;
}
.zui-uid { color: var(--mc-text); }
.zui-status {
  font-style: italic; color: var(--mc-text);
  font-size: 12px; margin-top: 10px;
  padding: 8px 12px; background: var(--mc-surface-alt); border-radius: 8px;
  line-height: 1.5;
}
.zui-section {
  text-align: left;
...
.zui-devices-label { color: var(--mc-text); }
.zui-actions {
...
.zui-crm-panel {
  background: linear-gradient(180deg,rgba(108,125,232,.12) 0%,var(--mc-surface) 100%);
  border-top: 1px solid rgba(25, 118, 210, 0.15);
  padding: 12px 16px;
}
.zui-crm-header {
  display: flex; align-items: center; gap: 6px;
  font-size: 11px; font-weight: 600; color: #aeb7ff;
...
.zui-stat-num {
  font-size: 18px; font-weight: 700; color: #aeb7ff;
  line-height: 1;
}
.zui-stat-score { color: #f57c00; }
.zui-stat-label {
  font-size: 10px; color: var(--mc-text);
  text-transform: uppercase; letter-spacing: 0.5px;
  margin-top: 2px;
}
.zui-crm-tags {
...
.zui-loading, .zui-error {
  display: flex; align-items: center; justify-content: center;
  padding: 30px; font-size: 13px; color: var(--mc-text);
}
</style>
