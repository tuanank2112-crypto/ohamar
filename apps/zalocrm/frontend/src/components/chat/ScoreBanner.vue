  ...
  <div class="score-banner">
    ...
    <div class="sb-stats">
      ...
      <div
        ...
        @mouseleave="hovered = null"
      >
        <div class="sb-icon"><CoolIcon name="Compass" :size="14" /></div>
      ...
      <div
        ...
        @mouseleave="hovered = null"
      >
        <div class="sb-icon"><CoolIcon name="Chat" :size="14" /></div>
    ...
    <div v-if="hovered" class="sb-tooltip" :class="`tt-${hovered}`">
      ...
      <template v-else-if="hovered === 'priority'">
        <div class="tt-title"><span class="tt-icon"><CoolIcon name="Compass" :size="14" /></span> Priority Score</div>
        <div class="tt-def">
      ...
      <template v-else-if="hovered === 'eng'">
        <div class="tt-title"><span class="tt-icon"><CoolIcon name="Chat" :size="14" /></span> Engagement Score</div>
        <div class="tt-def">
