...
.dd-option:hover { background: var(--mc-surface-alt); }
.dd-option.active { background: rgba(108,125,232,.14); }
.dd-color-dot {
  width: 12px;
  height: 12px;
  border-radius: 50%;
...
.dd-create-inline:hover { background: var(--mc-surface-alt); }
.dd-footer {
...
.dd-settings-link:hover { background: var(--mc-surface-alt); }
