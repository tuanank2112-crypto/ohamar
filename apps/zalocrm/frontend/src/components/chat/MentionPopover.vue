  ...
  <div class="mention-popover">
    <div class="mp-header">
      <div class="mp-avatar" :class="actorTypeClass">
        ...
        <span v-else-if="actorType === 'bot'"><CoolIcon name="Settings_Future" :size="14" /></span>
        <span v-else><CoolIcon name="Settings" :size="14" /></span>
      </div>
      <div class="mp-info">
    ...
    <div v-if="email" class="mp-row">
      <span class="mp-icon"><CoolIcon name="Mail" :size="14" /></span>
      <span class="mp-text">{{ email }}</span>
    </div>
    <div v-if="extra" class="mp-row">
      <span class="mp-icon"><CoolIcon name="Info" :size="14" /></span>
