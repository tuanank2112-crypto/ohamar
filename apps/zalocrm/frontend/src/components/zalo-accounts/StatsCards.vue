...
.stat-card.green .val { color: var(--mc-success) }
.stat-card.red .val { color: var(--mc-danger) }
.stat-card.yellow .val { color: var(--mc-warning) }
.stat-card.purple .val { color: #c4b5fd }
.stat-card.blue .val { color: #aeb7ff }
