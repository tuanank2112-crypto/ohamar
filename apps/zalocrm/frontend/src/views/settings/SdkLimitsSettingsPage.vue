...
.sdk-page-head .ico { width: 44px; height: 44px; border-radius: 12px; background: rgba(108,125,232,.14); display: grid; place-items: center; font-size: 22px; flex: none; }
.sdk-page-head h1 { font-size: 19px; font-weight: 700; margin: 0 0 4px; }
.sdk-page-head p { font-size: 13px; color: var(--mc-muted); margin: 0; line-height: 1.55; }
.sdk-page-loading { padding: 28px; text-align: center; color: var(--mc-muted); }
</style>
